 ...
 * generated in the ru.trandefil.tm.test package. 
...
public class ObjectFactory {
    ...
    private final static QName _Sum_QNAME = new QName("http://test.tm.trandefil.ru/", "sum");
    private final static QName _SumResponse_QNAME = new QName("http://test.tm.trandefil.ru/", "sumResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ru.trandefil.tm.test
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://test.tm.trandefil.ru/", name = "sum")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://test.tm.trandefil.ru/", name = "sumResponse")
