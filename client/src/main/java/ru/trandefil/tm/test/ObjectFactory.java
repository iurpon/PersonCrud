...
public class ObjectFactory {
    ...
    private final static QName _Div_QNAME = new QName("http://test.tm.trandefil.ru/", "div");
    private final static QName _DivResponse_QNAME = new QName("http://test.tm.trandefil.ru/", "divResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://test.tm.trandefil.ru/", name = "div")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://test.tm.trandefil.ru/", name = "divResponse")
