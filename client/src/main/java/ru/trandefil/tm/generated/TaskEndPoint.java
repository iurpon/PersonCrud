...
public interface TaskEndPoint {
    ...
    public ru.trandefil.tm.generated.TaskDTO updateTask(
        @WebParam(name = "task", targetNamespace = "")
        ru.trandefil.tm.generated.TaskDTO task,
    ...
    @WebResult(name = "return", targetNamespace = "")
    public java.util.List<ru.trandefil.tm.generated.TaskDTO> getAllTasks(
        @WebParam(name = "session", targetNamespace = "")
        ru.trandefil.tm.generated.Session session
    );
    ...
    @WebResult(name = "return", targetNamespace = "")
    public ru.trandefil.tm.generated.TaskDTO saveTask(
    ...
    @WebResult(name = "return", targetNamespace = "")
    public ru.trandefil.tm.generated.TaskDTO getTaskByName(
        @WebParam(name = "name", targetNamespace = "")
        java.lang.String name,
        @WebParam(name = "session", targetNamespace = "")
        ru.trandefil.tm.generated.Session session
    ...
    @WebResult(name = "return", targetNamespace = "")
    public ru.trandefil.tm.generated.TaskDTO deleteTask(
        @WebParam(name = "task", targetNamespace = "")
        ru.trandefil.tm.generated.TaskDTO task,
        @WebParam(name = "session", targetNamespace = "")
        ru.trandefil.tm.generated.Session session
    ...
    @WebResult(name = "return", targetNamespace = "")
    public ru.trandefil.tm.generated.TaskDTO deleteTaskByName(
        @WebParam(name = "name", targetNamespace = "")
        java.lang.String name,
        @WebParam(name = "session", targetNamespace = "")
        ru.trandefil.tm.generated.Session session
