...
public interface ProjectEndPoint {
    ...
    @WebMethod
    @Action(input = "http://generated.tm.trandefil.ru/ProjectEndPoint/getFileRequest", output = "http://generated.tm.trandefil.ru/ProjectEndPoint/getFileResponse", fault = {@FaultAction(className = IOException_Exception.class, value = "http://generated.tm.trandefil.ru/ProjectEndPoint/getFile/Fault/IOException")})
    @RequestWrapper(localName = "getFile", targetNamespace = "http://generated.tm.trandefil.ru/", className = "ru.trandefil.tm.generated.GetFile")
    @ResponseWrapper(localName = "getFileResponse", targetNamespace = "http://generated.tm.trandefil.ru/", className = "ru.trandefil.tm.generated.GetFileResponse")
    @WebResult(name = "return", targetNamespace = "")
    public java.lang.String getFile() throws IOException_Exception;
