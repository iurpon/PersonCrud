...
import ru.trandefil.tm.api.Project;
import ru.trandefil.tm.api.ProjectEndPoint;

/**
 * This class was generated by Apache CXF 3.2.7
 * 2019-02-07T18:35:16.686+03:00
...
public class ProjectEndPointImplService extends Service {
    ...
    public final static QName SERVICE = new QName("http://endpoint.tm.trandefil.ru/", "ProjectEndPointImplService");
    public final static QName ProjectEndPointImplPort = new QName("http://endpoint.tm.trandefil.ru/", "ProjectEndPointImplPort");
    static {
        URL url = null;
        try {
    ...
    public static void main(String[] args){
        List<Project> projectList = new ProjectEndPointImplService().getProjectEndPointImplPort().getAll();
