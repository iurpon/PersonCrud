...
public interface UserEndPoint {
    ...
    @WebMethod
    @Action(input = "http://generated.tm.trandefil.ru/UserEndPoint/getLoggedUserRequest", output = "http://generated.tm.trandefil.ru/UserEndPoint/getLoggedUserResponse")
    @RequestWrapper(localName = "getLoggedUser", targetNamespace = "http://generated.tm.trandefil.ru/", className = "ru.trandefil.tm.generated.GetLoggedUser")
    @ResponseWrapper(localName = "getLoggedUserResponse", targetNamespace = "http://generated.tm.trandefil.ru/", className = "ru.trandefil.tm.generated.GetLoggedUserResponse")
    @WebResult(name = "return", targetNamespace = "")
    public ru.trandefil.tm.generated.User getLoggedUser(
